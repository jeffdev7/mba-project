...
namespace fast_booze.data.Migrations
{
    /// <inheritdoc />
    public partial class _01 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LiquorStores", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    LiquorStoreId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stocks_LiquorStores_LiquorStoreId",
                        column: x => x.LiquorStoreId,
                        principalTable: "LiquorStores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Beverages_Stocks_StockId",
                        column: x => x.StockId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ItemOrders_Beverages_BeverageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Beverages_StockId",
                table: "Beverages",
                column: "StockId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemOrders_BeverageId",
                table: "ItemOrders",
                column: "BeverageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stocks_LiquorStoreId",
                table: "Stocks",
                column: "LiquorStoreId");
        }
